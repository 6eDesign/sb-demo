(function (global, factory) {
  ...
  */
  ...
  var bind = lib.bind;
  var registerPlugin = lib.registerPlugin;
  var util$1 = lib.util;
  var state$2 = lib.getState();
  ...
  var removeRepeatsFromState = function (obj) { 
    var newObj = util$1.extend({},state$2.boundObjects); 
  ...
  var onBind = function (objName,obj) { 
    ...
    if(!isARepeatKey(objName) && eligibleForDevTools) {
      devTools.send((objName + "-bound"), removeRepeatsFromState(state$2.boundObjects));
    } 
    return obj;
  };
